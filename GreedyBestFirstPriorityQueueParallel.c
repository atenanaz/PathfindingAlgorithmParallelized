...
int computeDistances(struct map *map, struct point *Currentpoint, struct point *endpoint, struct priorityQueue *queue) {
		...
		#pragma omp section 
		{
			...
			printf("thread %d is computing the right distance\n", omp_get_thread_num());		
		...
		#pragma omp section 
		{
			...
			printf("thread %d is computing the bottom distance\n", omp_get_thread_num());
		...
		#pragma omp section 
		{
			...
			printf("thread %d is computing the left distance\n", omp_get_thread_num());
		...
		#pragma omp section 
		{
			...
			printf("thread %d is computing the top distance\n", omp_get_thread_num());
